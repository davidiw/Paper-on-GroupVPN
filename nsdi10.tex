...
comparing a VPN models.  Finally, we give some concluding remarks in Section VI.
...
the server too must behave somewhat like a client by enabling a VPN endpoint
