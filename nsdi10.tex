...
IPTables~\cite{iptables} component called masquerade, which automatically
...
this approach is called a transparent subnet gateway~\cite{subnet_gateway} and
...
Our focus was on the use of IPTables~\cite{iptables} as it provides the ability
...
the use of relays in our evaluation in Section~\ref{evaluate_relays}.  When
