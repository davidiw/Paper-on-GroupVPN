...
of a central server for certificate management.  Additionally, we provide
a design and implementation of the first P2P VPN to support full tunneling,
whereby all non-P2P based Internet traffic routes through a trusted third party.
...
assist stability when the system is experiencing churn, that is when peers
...
\label{p2pvpn}
Prior to the discussion of this papers contributions, we will present our
previous works as they are the baseline for our P2P VPN.  Our previous research
involves implementing a P2P system similar to Symphony~\cite{symphony}, named
