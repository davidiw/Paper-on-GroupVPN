...
When NAT traversal using STUN~\cite{stun} fails or there is other connectivity
issues A handful of P2P VPNs~\cite{hamachi, gbridge} support relaying, similar
to Traversal Using Relay NAT (TURN)~\cite{turn}.  Though a majority of them
do not~\cite{wippien}.
