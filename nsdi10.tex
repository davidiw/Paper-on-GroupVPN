...
to let user's create and select their own relays.
...
FreePastry begin by looking up the mapping of virtual
...
FreePastry does not have the ability to form shortcuts based upon demands, so if two peers were
...
overlapped formed, relays will be created automatically using an existing infrastructure.
