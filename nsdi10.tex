...
SocialVPN places each client in their own VPN with only their friends on the
social network being members.  Unlike GroupVPN, this makes each user the master
