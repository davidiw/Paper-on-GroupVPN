...
and so if two peers do this simultaneously, they may be able to have both of
...
Similarly a structured P2P VPN can use the overlay, though as an overlay
...
To verify the usefulness of two-hop over overlay routing, we have evaluated
...
self-contained and requires that the user provide it to the VPN, by either
