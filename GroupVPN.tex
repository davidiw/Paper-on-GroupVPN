...
environment.  We describe how the VPN can be configured from a web
interface and use features of P2P systems to create an autonomic and
decentralized GroupVPN.  We then focus on enhancements that can be made to the
VPN made available by the use of structured overlays in terms of traffic
relaying and IP broadcast / multicast.
...
fails.  As the overlay grows in size, especially in structured overlays,
