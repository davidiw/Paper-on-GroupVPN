...
environment.  Examples of large, public overlay networks include Gnutella,
Kademlia, and Skype.  We describe how the VPN can be configured from a web
...
be impractical.  Archer consists of over 500 resources from 5 different universities,
...
Archer.  GroupVPN allows users to connect to the system and dynamically add
...
broadcast and multicast messages.  Once peers have registered with each other
through a social network, in future sessions, they can connect to the overlay
to discover and connect with each other.
